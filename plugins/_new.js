let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `POPDEK-MD 𝘾𝙃𝘼𝙉𝙉𝙀𝙇 𝙎𝙐𝙋𝙋𝙊𝙍𝙏\n\n _ʜᴇʏ ʜᴇʀᴇ's ᴏᴜʀ ᴄʜᴀɴɴᴇʟ ʟɪɴᴋ, ᴘʟᴇᴀsᴇ ғᴏʟʟᴏᴡ ᴀɴᴅ sᴜᴘᴘᴏʀᴛ ᴜs ᴛᴏ ᴋᴇᴇᴘ ᴛʜɪs ᴘʀᴏᴊᴇᴄᴛ ᴀʟɪᴠᴇ_\n *ʟɪɴᴋ:* https://whatsapp.com/channel/0029VajoIUN3LdQZQuVCP23y\n\n ${Config.botname} *©Popdek919*`;
...
smd(
 ...
 smd({
   ...
   try {
     let _0x12a593 = "*POPDEK-MD CURRENTLY ACTIVE!*";
