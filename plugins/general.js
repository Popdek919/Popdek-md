...
cmd(
  ...
  async (_0x4e4351) => {
    try {
      ...
      await _0x4e4351.send(util.format(_0x536aa6), {}, "Popdek", _0x680da4);
    } catch (_0x2ee8cc) {
...
cmd(
  ...
  async (_0xbda24) => {
    try {
      ...
      await _0xbda24.send(util.format(_0x3e1ea8.url), {}, "Popdek", _0x7d6de1);
    } catch (_0x1a2f02) {
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://github.com/Popdek919/POPDEK-MDd"
      );
      let _0x1c73f9 = (
        "\nPOPDEK-MD A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        ...
        "\n  *❲❒❳ Repo:* _https://github.com/Popdek919/POPDEK-MD_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
...
smd(
  {
    ...
    use: "234907866xx,Your_text_here",
    fromMe: true,
    filename: __filename,
  },
      ...
      if (!_0x14810d) {
        return await _0x165087.reply(
          "*Advertise of your Message*\n*by sending it to provided nmbr range.*\n" +
            prefix +
            "advt 234907866xx,Your_text_here"
        );
      }
      ...
      if (!_0xd9b857.includes("x")) {
        return _0x165087.send(
          "*You did not add x in number.*\n*Ex: " +
            prefix +
            "advt 234907866xx,Your_Message_here*  \n " +
            Config.caption
        );
      }
